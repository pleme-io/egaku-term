    ...
    crates = {
      ...
      "egaku" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "d474b1ef31aa22244c9fd5b2c8cfd287870cdf27";
          sha256 = "00y946c2hd6l9hmicxbk1xzfk604h3sgpxya4kg620ay59p1syr0";
        };
        dependencies = [
          {
            name = "serde";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "macros" "rt" "rt-multi-thread" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
